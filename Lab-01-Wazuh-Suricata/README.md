...
Log Ingestion: Learned how to bridge two different security tools using JSON log formats.

Network Visibility: Gained experience in configuring af-packet interfaces and managing NIDS rulesets.

Threat Mapping: Successfully identified how network alerts relate to specific MITRE ATT&CK techniques.
